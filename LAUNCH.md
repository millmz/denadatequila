...
| 8 | ~~Old subscriber list imported~~ **Done Sept 18.** The Squarespace list (about 385 people) and the old store's customers came in with the Shopify connection. The *Legacy subscribers* segment now picks them up by how they subscribed (list import, or the Shopify sync), so nothing needs tagging. Signups from the teaser form are the only ones outside it | — | Segment *Legacy subscribers* shows roughly 450; the launch campaign's recipient estimate is small |
